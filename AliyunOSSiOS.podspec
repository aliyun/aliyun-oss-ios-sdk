Pod::Spec.new do |s|
  ...
  s.source_files = 'Supporting Files/AliyunOSSiOS.h', 'AliyunOSSSDK/*.{h,m,c}', 'AliyunOSSSDK/OSSTask/*.{h,m}','AliyunOSSSDK/OSSFileLog/*.{h,m}', 'AliyunOSSSDK/OSSIPv6/*.{h,m}', 'AliyunOSSSDK/Signer/*.{h,m}'
  s.resource_bundles = {
