...
NSString * const AuthServer = @"http://0.0.0.0:9090/sts/getsts";
 ...
 */
- (void)ossInit {
    id<OSSCredentialProvider> credential = [[OSSAuthCredentialProvider alloc] initWithAuthServerUrl:AuthServer];
